...
- **File Retrieval**: Supports various file formats:
  - **Unstructured**: Test, Docs, PDFs from MinIO storage.
...
- **app/**: Contains the FastAPI application code.
  - **routers/**: API routes, including:
    - `ner_router`: Processes structured data directly.
  ...
  - **utils/**: Supportive utility files for additional project functionalities.
